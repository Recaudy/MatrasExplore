...
<section class="section-padding" id="shorts" style="background-color: #f8fafc;">
    <div class="container">
        <div class="section-header reveal">
            <div class="section-header-left">
                <h2>Video Shorts</h2>
                <p>Kumpulan momen dan pesona wisata dalam video singkat</p>
            </div>
            <a href="<?= base_url('shorts') ?>" class="btn btn-outline-primary" style="display: inline-flex; align-items: center; gap: 8px; font-weight: 700; padding: 12px 24px;">
                Lihat Semua Video
            </a>
        </div>

        <?php if (!empty($shorts)): ?>
        <div class="shorts-grid reveal" style="margin-top: 2rem;">
        ...
        <div class="text-center reveal" style="padding: 3rem 0; color: #64748b;">
            <p>Belum ada video shorts yang tersedia saat ini.</p>
        </div>
        <?php endif; ?>
    </div>
</section>
